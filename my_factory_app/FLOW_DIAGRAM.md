...
2. ตอนแอดมินอนุมัติคำขอ
3. ตอน stock ต่ำกว่า safety stock
4. ตอนสินค้าใกล้หมดอายุ
5. ตอนหมวกนิรภัยครบอายุการใช้งานหรือใกล้ครบกำหนดเปลี่ยน
...
flowchart TD
    ...
    B -->|คำขอเบิกใหม่| C[ส่ง LINE แจ้ง Admin]
    B -->|Admin อนุมัติ| D[ส่ง LINE แจ้งผลอนุมัติ]
    B -->|สต็อกต่ำ| E[ส่ง LINE เตือนสั่งซื้อ]
    B -->|ของใกล้หมดอายุ| F[ส่ง LINE แจ้งวันหมดอายุ]
    B -->|หมวกนิรภัยครบอายุ| G[ส่ง LINE แจ้งเปลี่ยนหมวก]
    ...
    H -->|CC| I[ส่งไป LINE กลุ่ม CC]
    H -->|PC1| J[ส่งไป LINE กลุ่ม PC1]
    H -->|รวมระบบ| K[ส่งผ่าน Daily Alert Job]
...
### รายละเอียดการแจ้งเตือนที่เพิ่มในระบบ

#### แจ้งเตือนวันหมดอายุ
- ใช้ตรวจสินค้าที่มี expiry_date
- แจ้งล่วงหน้าก่อนหมดอายุภายใน 30 วัน
- ใช้กับยาและสินค้าที่กำหนดวันหมดอายุ

#### แจ้งเตือนอายุการใช้งานหมวกนิรภัย
- ตรวจจากประวัติการเบิกหมวกนิรภัยที่อนุมัติแล้ว
- ใช้เพื่อเตือนเมื่อใกล้ครบหรือครบกำหนดเปลี่ยนตามรอบการใช้งาน
- ช่วยควบคุมความปลอดภัยของผู้ใช้งานจริงในหน้างาน
...
- มีการแจ้งเตือนสินค้าที่ใกล้หมดอายุ
- มีการแจ้งเตือนหมวกนิรภัยเมื่อครบอายุการใช้งานหรือใกล้ครบกำหนดเปลี่ยน
